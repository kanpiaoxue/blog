...
# git start
alias gitlog='git log --pretty=format:"%h %s ==&gt; author:%Cgreen%an" --graph'</pre> 
 <p style="font-size: 14px;">&nbsp;</p> 
 <p style="font-size: 14px;">&nbsp;</p> 
 <p style="font-size: 14px;">&nbsp;</p> 
 <p style="font-size: 14px;">&nbsp;</p> 
 ...
 <p style="font-size: 14px;">linux 中使用ls指定输出时间格式</p> 
 <p style="font-size: 14px;">https://blog.csdn.net/chaofanwei/article/details/13018753</p> 
 <p style="font-size: 14px;">&nbsp;</p> 
