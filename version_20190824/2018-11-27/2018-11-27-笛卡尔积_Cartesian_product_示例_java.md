...
public class CartesianProductUtils {
 ...
 <p>&nbsp;</p> 
 <p>&nbsp;</p> 
 <p class="p1">guava 的 Sets 和Lists 都提供了笛卡尔积的计算能力。但是Sets和Lists的cartesianProduct()方法是有区别的，Sets的笛卡尔积是对集合进行计算，其中计算的维度不允许由重复元素；Lists的笛卡尔积对list（列表）计算，其中计算的维度运行有重复元素。具体的功能可以参考他们的API文档。</p> 
 <p class="p1">Sets其实还提供了集合的并集、差集等一系列的集合操作。</p> 
